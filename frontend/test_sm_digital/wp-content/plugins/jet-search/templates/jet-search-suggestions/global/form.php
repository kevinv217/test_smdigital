...
<form class="jet-search-suggestions__form" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	...
	<div class="jet-search-suggestions__fields-holder">
		<div class="jet-search-suggestions__field-wrapper">
			<input class="jet-search-suggestions__field" type="search" placeholder="<?php echo esc_attr( $settings['search_placeholder_text'] ); ?>" value="<?php echo get_search_query(); ?>" name="s" autocomplete="off" />
